...
@javax.annotation.Generated(
    ...
    comments = "Source: com.firsttimeinforever.chat/ChatService.proto")
public final class ChatServiceGrpc {

  private ChatServiceGrpc() {}

  public static final String SERVICE_NAME = "com.firsttimeinforever.chat.ChatService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.firsttimeinforever.chat.ChatServiceOuterClass.ChatMessage,
      com.firsttimeinforever.chat.ChatServiceOuterClass.ChatMessageFromServer> getChatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "chat",
      requestType = com.firsttimeinforever.chat.ChatServiceOuterClass.ChatMessage.class,
      responseType = com.firsttimeinforever.chat.ChatServiceOuterClass.ChatMessageFromServer.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.firsttimeinforever.chat.ChatServiceOuterClass.ChatMessage,
      com.firsttimeinforever.chat.ChatServiceOuterClass.ChatMessageFromServer> getChatMethod() {
    io.grpc.MethodDescriptor<com.firsttimeinforever.chat.ChatServiceOuterClass.ChatMessage, com.firsttimeinforever.chat.ChatServiceOuterClass.ChatMessageFromServer> getChatMethod;
    if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
      synchronized (ChatServiceGrpc.class) {
        if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
          ChatServiceGrpc.getChatMethod = getChatMethod =
              io.grpc.MethodDescriptor.<com.firsttimeinforever.chat.ChatServiceOuterClass.ChatMessage, com.firsttimeinforever.chat.ChatServiceOuterClass.ChatMessageFromServer>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "chat"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.firsttimeinforever.chat.ChatServiceOuterClass.ChatMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.firsttimeinforever.chat.ChatServiceOuterClass.ChatMessageFromServer.getDefaultInstance()))
  ...
  public static abstract class ChatServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.firsttimeinforever.chat.ChatServiceOuterClass.ChatMessage> chat(
        io.grpc.stub.StreamObserver<com.firsttimeinforever.chat.ChatServiceOuterClass.ChatMessageFromServer> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                com.firsttimeinforever.chat.ChatServiceOuterClass.ChatMessage,
                com.firsttimeinforever.chat.ChatServiceOuterClass.ChatMessageFromServer>(
                  this, METHODID_CHAT)))
          .build();
    }
  }
  ...
  private static abstract class ChatServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.firsttimeinforever.chat.ChatServiceOuterClass.getDescriptor();
    }
